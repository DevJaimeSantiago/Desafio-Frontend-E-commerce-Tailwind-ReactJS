...
import SlideProduct from '@/components/products/gallery/SlideProduct'
import ModalProduct from '@/components/products/gallery/SlideProduct'
        ...
        <>
            ...
            {isOpenModal && (
                <>
                    ...
                    />
                    <span className='fixed top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.5)]' onClick={handleCloseModal}></span>
                </>
            )}
        </>
    )
